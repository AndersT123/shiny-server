...
option_list <- list(
  ...
  make_option(c("-o", "--out"), type = "character", default = "new-league",
              help = "name of directory in data/. [default=%default]", metavar = "character"),
  make_option(c("-a", "--add"), type = "logical", default = F,
...
create_league <- function(league_name = opt$out, # path to where the league structure should begin
